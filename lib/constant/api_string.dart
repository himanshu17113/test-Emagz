class ApiEndpoint {
  ...
  static String baseUrl =
      "http://ec2-13-233-123-161.ap-south-1.compute.amazonaws.com:3000/api";
  static String socketUrl =
      "http://ec2-13-233-123-161.ap-south-1.compute.amazonaws.com:3000/socket_connection";
  static String userInfo(String userId) =>
      "$baseUrl/auth/get-user-details/$userId";
  ...
  static String setupProfessionalAccount =
      "$baseUrl/auth/setup-professional-account";

  static String chooseIntrest = "$baseUrl/auth/addInterest/";
  static String uniqueName(String userId) =>
      "$baseUrl/auth/profile/get-unique-name/$userId";
  ...
  static String removeSingleNotification(String notificationId) =>
      "$baseUrl/notification/remove/$notificationId";
  static String clearAllNotification(String userID) =>
      "$baseUrl/notification/clearAll/$userID";
  ...
  static String likePost(String postId) =>
      "$baseUrl/post/$postId/likeANDunlike";
  ...
  static String pollResults(String postId) =>
      "$baseUrl/post/$postId/PollResults";

  static String makePost = "$baseUrl/post/";

  //chats

  static String getConversation(String userId) =>
  ...
  static String acceptRequest(String userId) =>
      "$baseUrl/chat_setting/requests/$userId/accept";
  static String strikeFirstCon = "$baseUrl/conversations/";
  static String getConID(String userId, String secUserId) =>
      "$baseUrl/conversations/find/$userId/$secUserId";
