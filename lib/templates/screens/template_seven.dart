      ...
      body: ListView(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  backgroundImage: CachedNetworkImageProvider(products[3].image.toString()),
                ),
                const SizedBox(
                  height: 25,
                ),
                Row(
                  ...
                  children: [
                    CircleAvatar(
                      radius: 25,
                      backgroundImage: CachedNetworkImageProvider(products[1].image.toString()),
                    ),
                    CircleAvatar(
                      radius: 25,
                    ...
                    CircleAvatar(
                      radius: 25,
                      backgroundImage: CachedNetworkImageProvider(products[4].image.toString()),
                    ),
                  ],
                ),
                const SizedBox(
                ...
                Text(
                  "Esther Howard",
                  style: GoogleFonts.aBeeZee(color: whiteColor, fontSize: 28, fontWeight: FontWeight.w400),
                ),
                const SizedBox(
                  height: 20,
                ),
                Padding(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.aBeeZee(color: whiteColor, fontSize: 13, height: 1.4, fontWeight: FontWeight.w300),
                  ),
                ),
              ],
            ),
              ...
              children: [
                Column(
                  children: [
                    Text(
                      "2500",
                      style: TextStyle(color: grayColor, fontSize: 35, height: .2, fontWeight: FontWeight.w400),
                    ),
                    Row(
                      children: [
                        SizedBox(
          ...
          Text(
            "About",
            textAlign: TextAlign.center,
            style: GoogleFonts.aBeeZee(color: blackButtonColor, fontSize: 28, fontWeight: FontWeight.w600),
          ),
          const SizedBox(
            height: 20,
          ),
          ...
          Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: blackButtonColor, border: Border.all(color: blackButtonColor)),
                child: Text(
                  "Favourite",
          ...
          SizedBox(
            ...
            child: PageView.builder(
                ...
                itemBuilder: (context, pagePosition) {
                  return SliderCard(images: products[pagePosition].image.toString());
                }),
          ),
          Padding(
