...
class TemplateSixScreen extends StatefulWidget {
  const TemplateSixScreen({super.key});
          ...
          children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.montserrat(color: whiteColor, fontWeight: FontWeight.w400, fontSize: 15),
                      ),
                      const SizedBox(
                        width: 10,
                      ),
            ...
            Row(
              children: [
                ...
                Text(
                  "Our Products",
                  textAlign: TextAlign.center,
                  style: GoogleFonts.sahitya(color: blackButtonColor, fontWeight: FontWeight.w700, fontSize: 30),
                ),
                const SizedBox(
                  width: 20,
                ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Product.1",
                            textAlign: TextAlign.center,
                            style: GoogleFonts.sahitya(color: whiteColor, height: .1, fontWeight: FontWeight.w700, fontSize: 30),
                          ),
                          Row(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    margin: const EdgeInsets.only(top: 24, left: 50, bottom: 15),
                    child: Text(
                      "Reach us",
                      textAlign: TextAlign.start,
