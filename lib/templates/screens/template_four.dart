          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Store Name",
                    style: GoogleFonts.josefinSans(color: whiteColor, fontSize: 32, fontWeight: FontWeight.w600),
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  SizedBox(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.inter(color: whiteColor, fontSize: 14, fontWeight: FontWeight.w300),
                    ),
                  ),
                  const SizedBox(
                    height: 10,
            ...
            Padding(
              ...
              child: Text(
                ...
                style: GoogleFonts.judson(color: blackButtonColor, fontSize: 30, fontWeight: FontWeight.w600),
              ),
            ),
            const SizedBox(
              height: 10,
            ...
            Padding(
              ...
              child: Text(
                ...
                style: GoogleFonts.inter(color: blackButtonColor, fontSize: 14.7, height: 1.5, fontWeight: FontWeight.w300),
              ),
            ),
            const SizedBox(
              height: 15,
            ...
            Text(
              "Trending Product",
              textAlign: TextAlign.center,
              style: GoogleFonts.poppins(color: blackButtonColor, fontSize: 25, fontWeight: FontWeight.w400),
            ),
            const SizedBox(
              height: 20,
            ),
