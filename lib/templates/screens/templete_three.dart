          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.italiana(color: const Color(0xff262626), fontSize: 64, height: 1, fontWeight: FontWeight.w300),
              ),
              const SizedBox(
                height: 10,
              ),
              ...
              Text(
                "Our Story",
                textAlign: TextAlign.center,
                style: GoogleFonts.italiana(color: const Color(0xff262626), fontSize: 48, height: 1, fontWeight: FontWeight.w300),
              ),
              const SizedBox(
                height: 60,
              ),
              Padding(
                ...
                child: Text(
                  ...
                  style: GoogleFonts.inter(color: const Color(0xff454545), fontSize: 14.5, fontWeight: FontWeight.w300),
                ),
              ),
              Container(
              ...
              Padding(
                ...
                child: Text(
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Risus, maecenas vestibulum amet, cursus platea fringilla viverra laoreet lacus. Lorem lobortis tellus pretium, amet auctor ultricies non. Non praesent risus massa et morbi. \n\nLorem ipsum dolor sit amet, consectetur adipiscing elit. Risus, maecenas vestibulum amet, cursus platea fringilla viverra laoreet lacus. Lorem lobortis tellus pretium, amet auctor ultricies non. Non praesent risus massa et morbi. ",
                  textAlign: TextAlign.justify,
                  style: GoogleFonts.inter(color: const Color(0xff454545), fontSize: 14.7, fontWeight: FontWeight.w300),
                ),
              ),
              const SizedBox(
                height: 30,
              ...
              Text(
                "Product",
                textAlign: TextAlign.center,
                style: GoogleFonts.italiana(color: blackButtonColor, fontSize: 35, height: 1, fontWeight: FontWeight.w300),
              ),
              const SizedBox(
                height: 30,
              ),
              ...
              Text(
                "Gallery",
                textAlign: TextAlign.center,
                style: GoogleFonts.italiana(color: blackButtonColor, fontSize: 32, height: 1, fontWeight: FontWeight.w300),
              ),
              const SizedBox(
                height: 30,
              ),
