        ...
        body: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Store Name",
                    style: GoogleFonts.inter(color: whiteColor, fontSize: 32, fontWeight: FontWeight.w600),
                  ),
                  const SizedBox(
                    height: 5,
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.inter(color: blackButtonColor, fontSize: 22, fontWeight: FontWeight.w600),
                        ),
                        const SizedBox(
                          height: 5,
                        ),
                        SizedBox(
                          ...
                          child: Text(
                            ...
                            textAlign: TextAlign.center,
                            style: GoogleFonts.inter(color: blackButtonColor, fontSize: 12, fontWeight: FontWeight.w400),
                          ),
                        ),
                      ],
                    ),
            ...
            Text(
              "Get your style",
              textAlign: TextAlign.center,
              style: GoogleFonts.inter(color: blackButtonColor, fontSize: 30, fontWeight: FontWeight.w600),
            ),
            const SizedBox(
              height: 10,
            ),
