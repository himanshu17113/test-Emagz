              ...
              children: [
                ...
                Positioned(
                  ...
                  child: SizedBox(
                      ...
                      child: Text(
                        "JAMESWOOD",
                        style: GoogleFonts.secularOne(color: whiteColor, fontSize: 27, height: .9, fontWeight: FontWeight.w400),
                      )),
                ),
                Positioned(
                  bottom: 210,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "My Intro",
                  style: GoogleFonts.secularOne(color: whiteColor, fontSize: 30, fontWeight: FontWeight.w400),
                ),
                const SizedBox(
                  height: 10,
                ),
                Text(
                  ...
                  style: GoogleFonts.roboto(color: whiteColor, fontSize: 12, letterSpacing: .5, fontWeight: FontWeight.w300),
                ),
                const SizedBox(
                  height: 20,
                ),
                ...
                Center(
                  child: Text(
                    "Short Message",
                    textAlign: TextAlign.center,
                    style: GoogleFonts.italiana(color: chatContainer, fontSize: 30, fontWeight: FontWeight.w400),
                  ),
                ),
                const SizedBox(
                  height: 10,
                ...
                const Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(color: Color(0xff686868), fontSize: 14, fontWeight: FontWeight.w200),
                ),
                const SizedBox(
                  height: 40,
                ),
                Center(
                  child: Text(
                    "Thank You ",
                    textAlign: TextAlign.center,
                    style: GoogleFonts.aguafinaScript(color: const Color(0xff686868), letterSpacing: 2, fontSize: 35),
                  ),
                ),
                const SizedBox(
                  height: 40,
