...
class CustomVideoPlayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(videoUrl);
    return Obx(
      () => ( post.sId == videoPlayerController.currentId.value) ? InkWell(
        onTap: () {
        ...
        child: Stack(
          ...
          Obx(() => videoPlayerController.isPlayed.value ? Container()
        ...
        child: Container(
          ...
          child: Center(child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 20,),
              Text("video thumbnail",style: TextStyle(color: Colors.white,fontSize: 28),),
              Text("will be replaced when it will be received ",style: TextStyle(color: Colors.white,fontSize: 14),),
            ],
          )),
        ),
      ),
