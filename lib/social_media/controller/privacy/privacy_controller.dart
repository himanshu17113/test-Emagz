...
class PrivacyController extends GetxController {
  ...
  privacyCommentControl(bool everyone, bool follower, bool follow, bool followFollowers) async {
    ...
    Map bodymain = {"everyone": everyone, "followers": follower, "follow": follow, "follow_and_followers": followFollowers};
    Map body = {"comment_privacy": bodymain};
    debugPrint(ApiEndpoint.commentprivacy);
    debugPrint(body.toString());
    http.Response response = await http.post(Uri.parse(ApiEndpoint.commentprivacy), body: jsonEncode(body), headers: headers);
  ...
  privacyPostControl(bool everyone, bool followers, bool noOne) async {
    ...
    debugPrint(body.toString());
    http.Response response = await http.post(Uri.parse(ApiEndpoint.postPrivacy), body: jsonEncode(body), headers: headers);
    Map data = jsonDecode(response.body);
    debugPrint("code${response.statusCode.toString()}");
  ...
  privacyMentionControl(bool everyone, bool followers, bool noOne) async {
    ...
    debugPrint(body.toString());
    http.Response response = await http.post(Uri.parse(ApiEndpoint.mentionPrivacy), body: jsonEncode(body), headers: headers);
    Map data = jsonDecode(response.body);
    debugPrint("code${response.statusCode.toString()}");
  ...
  privacyStoryControl(bool everyone, bool closeFriends) async {
    ...
    http.Response response = await http.post(Uri.parse(ApiEndpoint.storyPrivacy), body: jsonEncode(body), headers: headers);
    Map data = jsonDecode(response.body);
    debugPrint("code${response.statusCode.toString()}");
    debugPrint(body.toString());
    if (response.statusCode == 200) {
  ...
  privacyLiveControl(bool everyone, bool followers, bool noone) async {
    ...
    debugPrint(body.toString());
    http.Response response = await http.post(Uri.parse(ApiEndpoint.livePrivacy), body: jsonEncode(body), headers: headers);
    Map data = jsonDecode(response.body);
    debugPrint("code${response.statusCode.toString()}");
  ...
  privacyMessageControl(bool everyone, bool followers, bool noOne) async {
    ...
    debugPrint(body.toString());
    http.Response response = await http.post(Uri.parse(ApiEndpoint.messagePrivacy), body: jsonEncode(body), headers: headers);
    Map data = jsonDecode(response.body);
    debugPrint("code${response.statusCode.toString()}");
